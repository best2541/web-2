                            ...
                            <form onSubmit={submitClick}>
                                <Row>
                                    <Col sm='12' md='4'>
                                        ...
                                        <Input id='FTP_ACC' name='FTP_ACC' type='select' onChange={inputChange}>
                                    ...
                                    <Col sm='12' md='4'>
                                        ...
                                        <Input id='FTP_PROTOCAL' name='FTP_PROTOCAL' type='select' onChange={inputChange}>
                                    ...
                                    <Col sm='12' md='4'>
                                        ...
                                        <Input id='FTP_HOSTNAME' name='FTP_HOSTNAME' onChange={inputChange} />
                                    </Col>
                                </Row>
                                <Row>
                                    <Col sm='12' md='4'>
                                        ...
                                        <Input id='FTP_USERNAME' name='FTP_USERNAME' onChange={inputChange} />
                                    </Col>
                                    <Col sm='12' md='4'>
                                        <Label for='FTP_PASSWORD'>
                                            Password
                                        </Label>
                                        <Input id='FTP_PASSWORD' name='FTP_PASSWORD' type='password' onChange={inputChange} />
                                    </Col>
                                    <Col sm='12' md='4'>
                                        <Label for='FTP_PATH'>
                                            Path
                                        </Label>
                                        <Input id='FTP_PATH' name='FTP_PATH' onChange={inputChange} />
                                    </Col>
                                </Row>
                                <Row>
                                    <Col sm='12' md='4'>
                                        ...
                                        <Input id='FTP_PORT' name='FTP_PORT' onChange={inputChange} />
                                    </Col>
                                </Row>
                                <br />
