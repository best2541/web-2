...
const ForgotPassword = () => {
  ...
  const onSubmit = async () => {
    // Call API ForgotPassword
  }

  const routeUpdatePass = () => {
    history.push({
      ...
      <div className='auth-wrapper auth-v2 font-montserrat'>
        <Row className='auth-inner m-0'>
          <Link className='brand-logo' to='/' onClick={e => e.preventDefault()}>
            ...
            <h2 className='brand-text text-primary ml-1'>ANTS</h2> */}
          </Link>
          ...
          <Col className='d-flex align-items-center auth-bg px-2 p-lg-5' lg='4' sm='12'>
            <Col className='px-xl-2 mx-auto' sm='8' md='6' lg='12'>
              ...
              <Button color='warning' block onClick={() => routeUpdatePass()}>
                UpdatePassword  (For Test)
              </Button>
            </Col>
          </Col>
        </Row>
