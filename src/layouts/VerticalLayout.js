...
const VerticalLayout = props => {
  ...
  const navbarWrapperClasses = {
    ...
    hidden: windowWidth >= 1200 ? 'navbar-hidden' : 'navbar-floating'
  }
  ...
  const navbarClasses = {
    ...
    hidden: windowWidth >= 1200 ? 'd-none' : 'floating-nav'
  }
  ...
  return (
    ...
    >
      ...
      <Navbar
        ...
        className={classnames(
          `header-navbar navbar header-bar align-items-center ${navbarClasses[navbarType] || 'floating-nav'}`
        )}
      >
